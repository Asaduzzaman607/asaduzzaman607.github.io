=== Ecommerce by 10Web - eCommerce shopping cart plugin ===
Contributors: 10web, webdorado
Tags:  cart, checkout, e-commerce, ecommerce, paypal, sales, shop, store, shipping, product catalog,  online store, shopping cart
...
Ecommerce by 10Web is a highly-functional, user friendly WordPress Ecommerce plugin, which is perfect for developing online stores. 
...
[Premium eCommerce by 10Web](https://10web.io/plugins/wordpress-ecommerce/)    
    
    
[Special Offer for all Premium Plugins](https://10web.io/plugins-bundle-pricing/)  
   
https://www.youtube.com/watch?v=YuPXzYELGEA

       
= Ecommerce by 10Web Extensions: =
_[Available in Plugins Bundle](https://10web.io/plugins/wordpress-ecommerce/#product_pricing)_

 *  Stripe Integration Extension  
 *  Filters Extension  
 *  Mini Cart Extension  
 *  Latest Products Extension  
 *  Top Rated Products Extension  
 *  Bestsellers Extension  
	   
Ecommerce by 10Web is a highly-functional, user friendly WordPress plugin, which is perfect for developing online stores for any level of complexity. 

This plugin for WordPress includes advanced filtering, sorting and comparing functionality which makes user experience in the store straightforward and smooth. The advanced search in addition gives possibility to find any needed info in seconds. 
...
This ecommerce plugin supports three types of payment processing - without online payment , PayPal Standard and PayPal Express (available with Paid version). 
...
Paid version includes 5 built-in themes, and you can also create new themes or edit existing ones.

The products can be displayed in 5 views- Thumbnail and List (Free version) and Masonry, Chess and Blog Style (Paid version).


Upgrade to [Paid version](https://10web.io/plugins/wordpress-ecommerce/) to get access to
...
= 1.2.14 = 
* Changed: Moved to 10Web.

= 1.2.13 = 
* Fixed: Checkout with disabled "Rest of the world" shipping zone.  
* Fixed: Do not print js before DOCTYPE.   

= 1.2.12 = 
* Fixed: Bug on redirecting to shopping cart after adding an item.   
* Changed: Hide shipping info in checkout if not available.   
...
= 1.2.9 = 
* Fixed: Error on checkout in some php versions.   

= 1.2.8 = 
* Fixed: Shortcode pop-up style in WP 4.8.   

= 1.2.7 = 
* Changed: Allow empty layout parameter in shortcode.    
* Fixed: Shortcode tag module box bug.    

= 1.2.6 = 
* Changed: French translation (Thanks to Florian Martin).    
* Fixed: Warnings in setup wizard.   

= 1.2.5 = 
* Fixed: Conflict depend on php version.   
* Fixed: Removed help topic from unnecessary pages.    
...
= 1.2.3 =
* Fixed: Conflict depend on php version.   
* Fixed: Rename session id parameter name to avoid conflict with hostings.   
* Added: Possibility add multiple emails for administrator.   
* Added: Support forum link.   
* Added: 'wde_activate' action hook.   
* Changed: Hide not configured payment buttons.   
  
= 1.2.2 =
* Fixed: Total price with discount.   
* Fixed: Product shipping costs calculation with multiple classes.   
* Fixed: Save free shipping for orders over a certain price.   
* Fixed: Product view parameters tab.   
* Fixed: User email on user management page.  
* Changed: Check required parameters in frontend.   
* Added: Ecommerce by 10Web Stripe Integration Extension support.   
* Added: Overview page.    

= 1.2.1 =
* Chanaged: Generate styles on theme save.    
* Fixed: Quick view styles.    
  
= 1.2.0 =
* Added: Shipping zones.   
* Added: Shipping classes.   
* Added: Show shipping on shoppin cart page (optional).   
* Added: Allow to select country on shopping cart page (optional).   
* Added: Shipping default destination (optional).   
* Fixed: Removed products data table empty columns from orders and email.  
* Fixed: Remove out of stock product price from overall amount and disable quantity in shopping cart.  
* Fixed: Mobile in email.  

= 1.1.9 =
* Fixed: Filter by category.   
* Fixed: Product save with input type parameter.   
* Fixed: Less helper conflict.   
  
= 1.1.8 =
* Fixed: Removed empty columns from orders and email.      
* Fixed: Total price bug in checkout store function.     
  
= 1.1.7 =
* Fixed: Parameters price bug in paypal.    
* Fixed: Translations.   

= 1.1.6 =
* Added: Bestsellers Extension.     

= 1.1.5 =
* Added: Top rated products Extension.   
* Fixed: Admin styles on Wordpress 4.7.   
* Fixed: Widget in theme customization page.    
  
= 1.1.4 =
* Added: Latest product Extension.   
...
== Screenshots ==
1.  Ecommerce by 10Web  - Products View       
2.  Ecommerce by 10Web  - Single Product View         
3.  Ecommerce by 10Web  - Manufacture         
4.  Ecommerce by 10Web  - Category     
5.  Ecommerce by 10Web  - Edit Product     
6.  Ecommerce by 10Web  - Edit Options      


== Installation ==

#### Thank you for your interest in Ecommerce by 10Web.
...
As a result of installation three menu sections will be added to your WordPress Dashboard Ecommerce by 10Web, Products and Ecommerce Pages. 

= Where can I configure the settings of the plugin? =

Options menu is the first step while creating an online store. Here you set up general and payment options. Options contain the following tabs:
...
By default Ecommerce by 10Web uses its own template for product, manufacturer and category pages, but you can make necessary changes in Manage Templates. General Templates button uses website active theme and generates the pages using design of the theme. This works for most of the themes written strictly in WordPress standard.

Otherwise you can manually add the php code to the template using Import from Theme template option instead. To reset the changes press Custom Template. which is the ecommerce default design. 

= Is it possible to modify product options? =

In Products tab of Ecommerce by 10Web Options you can change weight and dimensions units, as well as enable/disable SKU, UPC, EAN, JAN, ISBN, MPN. 

In Feedback tab enable/disable product rating and review possibility.

In Social Media tab you can enable social media sharing buttons and enable Facebook comments instead of standard comments and choose color scheme for the Facebook comments box (light or dark depending on your preference).

= Where can I edit checkout settings? =

On Ecommerce by 10Web Options > Checkout tab you can enable checkout, allow guest checkout (for non- registered users), redirect to cart after adding an item and enable/disable payment gateways and configure the options using Payment systems button for the all list or click on a payment gateways for a single one. 
...
= Can I apply tax or discount on products? =

Additional Charges and Discounts settings allow you to choose whether to include discounts and taxes in the final price of the product or not and set shipping calculation- per group (in case of identical shipping methods the bundle will be considered as a single unit, whereas in case of different methods for included items the shipping will be calculated for each product separately) of per unit (each unit will have its own shipping charge).  

= How can I edit user settings? =

Navigate to Users tab of Ecommerce by 10Web Options. Here you can enable/disable details necessary for the checkout. You can set the input fields to required as well.

= Where can I set up email notifications? =

Visit Email Options tab of Ecommerce by 10Web Options.
...
= Is it possible to manage custom pages of the plugin? =

Navigate to Standard pages tab of Ecommerce by 10Web Options. Here you can specify permalink structures  as well as path component for action page, e.g. Compare or List of license pages.

= How can I create a product with the plugin? =
...
= Where can I add product categories? =

Go to Products > Categories. Here fill in name, slug, parent category, description and meta data, image, choose parameters and tags for the category. Then if applicable enable information and products for this specific category page, subcategory display and category hierarchy.

Set the number of visible products and number of columns. To finalize the changes press Add new category button.

= Is it possible to add attributes to products? =

You can add the following additional attributes to the products:
...
To add labels to products, go to Products > Labels. Labels are overlay images which are added to differentiate products, e.g. New, 30% off and etc. Here add name, slug, description, upload the overlay image and finally choose the position of it over the image from 4 available positions.

Press Add label button.

To add Manufacturers to products, go to Products > Manufacturer.

Manufacturer is a custom post, where you can fill in the Title and description of the manufacturer as a post title and content, then add the website of the page. Then you need to enable/disable added details display and product display referring to this manufacturer, define their number. As a final step you should fill in metadata and set a featured image and press Publish button.

= How can I choose and add themes to ecommerce catalog? =
...
= Where can I manage ratings, discounts and taxes? =
...
= How can I publish Ecommerce by 10Web on pages or posts? =

In editor of a page/post find Ecommerce by 10Web icon (shaped as a shopping cart), click on it. Set up the options and press Insert button. Shortcode uses  three tabs for creating product list, categories or manufacturers pages.
