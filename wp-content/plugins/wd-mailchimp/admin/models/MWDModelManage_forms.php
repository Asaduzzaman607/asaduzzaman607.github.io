...
class MWDModelManage_forms {

	public function get_lists() {
    $api_key = get_option('mwd_api_key', '');
    $mwd_lists = MWD_Library::mailchimp_curl_connect( '/lists/', 'GET', $api_key);
		return $mwd_lists;
	}
    ...
    $api_key = get_option('mwd_api_key', '');
		$merge_variables_data = MWD_Library::mailchimp_curl_connect( '/lists/'.$list_id.'/merge-fields', 'GET', $api_key);
    ...
    $merge_var = (array) $merge_var;
		...
		if ( isset( $merge_var['options']->choices ) ) {
			$array['choices'] = $merge_var['options']->choices;
		}

		if ( isset( $merge_var['options']->dateformat ) ) {
			$array['dateformat'] = $merge_var['options']->dateformat;
		}

		if ( isset( $merge_var['options']->defaultcountry_cc ) ) {
			$array['defaultcountry_cc'] = $merge_var['options']->defaultcountry_cc;
		}
		return (object) $array;
	}
	...
	public function get_rows_data() {
		global $wpdb;
		$where = array();
		if(isset($_POST['search_value']) && (esc_html($_POST['search_value']) != ''))
			$where[] = '`title` LIKE "%' . esc_html($_POST['search_value']) . '%"';

		if(isset($_POST['search_select_value_type']) && (esc_html($_POST['search_select_value_type']) != '0'))
			$where[] = '`type` = "' . esc_html($_POST['search_select_value_type']) . '"';

		if(isset($_POST['search_select_value_list']) && (esc_html($_POST['search_select_value_list']) != '0'))
			$where[] = '`list_id` like "%' . esc_html($_POST['search_select_value_list']) . '%"';
		...
		$query = "SELECT * FROM " . $wpdb->prefix . "mwd_forms " . $where . $order_by . " LIMIT " . $limit . ",20";
	...
	public function get_display_options($id) {
		global $wpdb;
		$row = $wpdb->get_row($wpdb->prepare('SELECT * FROM ' . $wpdb->prefix . 'mwd_display_options WHERE form_id="%d"', $id));
	...
	public function get_row_data_new($id) {
		global $wpdb;
		if ($id != 0) {
			$row = $wpdb->get_row($wpdb->prepare('SELECT * FROM ' . $wpdb->prefix . 'mwd_forms_backup WHERE backup_id="%d"', $id));
			$labels2 = array();
			$label_id = array();
				...
				if (strpos($form, '%'.$id.' - '.$label.'%') || strpos($form, '%'.$id.' -'.$label.'%')) {
					...
					switch($type) {
						case 'type_section_break': {
							$arrows =$arrows.'<div id="wdform_arrows'.$id.'" class="wdform_arrows" ><div id="X_'.$id.'" class="element_toolbar"><img src="' . MWD_URL . '/images/delete_el.png" title="Remove the field" onclick="remove_section_break(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;delete_el&quot;)" onmouseout="chnage_icons_src(this,&quot;delete_el&quot;)"></div><div id="edit_'.$id.'" class="element_toolbar"><img src="' . MWD_URL . '/images/edit.png" title="Edit the field" onclick="edit(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;edit&quot;)" onmouseout="chnage_icons_src(this,&quot;edit&quot;)"><span id="'.$id.'_element_labelform_id_temp" style="display: none;">custom_'.$id.'</span></div><div id="duplicate_'.$id.'" class="element_toolbar"><img src="' . MWD_URL . '/images/duplicate.png" title="Duplicate the field" onclick="duplicate(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;duplicate&quot;)" onmouseout="chnage_icons_src(this,&quot;duplicate&quot;)"></div></div>';
						break;
					}
						case 'type_editor':	{
							$arrows =$arrows.'<div id="wdform_arrows'.$id.'" class="wdform_arrows" type="type_editor" style="margin-top:0px;"><div id="X_'.$id.'" valign="middle" align="right" class="element_toolbar"><img src="' . MWD_URL . '/images/delete_el.png" title="Remove the field" onclick="remove_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;delete_el&quot;)" onmouseout="chnage_icons_src(this,&quot;delete_el&quot;)"></div><div id="left_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/left.png" title="Move the field to the left" onclick="left_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;left&quot;)" onmouseout="chnage_icons_src(this,&quot;left&quot;)"></div><div id="up_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/up.png" title="Move the field up" onclick="up_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;up&quot;)" onmouseout="chnage_icons_src(this,&quot;up&quot;)"></div><div id="down_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/down.png" title="Move the field down" onclick="down_row(&quot;'.$id.'&quot;)"  onmouseover="chnage_icons_src(this,&quot;down&quot;)" onmouseout="chnage_icons_src(this,&quot;down&quot;)"></div><div id="right_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/right.png" title="Move the field to the right" onclick="right_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;right&quot;)" onmouseout="chnage_icons_src(this,&quot;right&quot;)"></div><div id="edit_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/edit.png" title="Edit the field" onclick="edit(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;edit&quot;)" onmouseout="chnage_icons_src(this,&quot;edit&quot;)"></div><div id="duplicate_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/duplicate.png" title="Duplicate the field" onclick="duplicate(&quot;'.$id.'&quot;)"  onmouseover="chnage_icons_src(this,&quot;duplicate&quot;)" onmouseout="chnage_icons_src(this,&quot;duplicate&quot;)"></div><div id="page_up_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/page_up.png" title="Move the field to the upper page" onclick="page_up(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;page_up&quot;)" onmouseout="chnage_icons_src(this,&quot;page_up&quot;)"></div><div id="page_down_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/page_down.png" title="Move the field to the lower page" onclick="page_down(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;page_down&quot;)" onmouseout="chnage_icons_src(this,&quot;page_down&quot;)"></div></div>';
					break;
				}
						...
						case 'type_recaptcha': {
							$arrows =$arrows.'<div id="wdform_arrows'.$id.'" class="wdform_arrows"><div id="X_'.$id.'" valign="middle" align="right" class="element_toolbar"><img src="' . MWD_URL . '/images/delete_el.png" title="Remove the field" onclick="remove_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;delete_el&quot;)" onmouseout="chnage_icons_src(this,&quot;delete_el&quot;)"></div><div id="left_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/left.png" title="Move the field to the left" onclick="left_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;left&quot;)" onmouseout="chnage_icons_src(this,&quot;left&quot;)"></div><div id="up_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/up.png" title="Move the field up" onclick="up_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;up&quot;)" onmouseout="chnage_icons_src(this,&quot;up&quot;)"></div><div id="down_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/down.png" title="Move the field down" onclick="down_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;down&quot;)" onmouseout="chnage_icons_src(this,&quot;down&quot;)"></div><div id="right_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/right.png" title="Move the field to the right" onclick="right_row(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;right&quot;)" onmouseout="chnage_icons_src(this,&quot;right&quot;)"></div><div id="edit_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/edit.png" title="Edit the field" onclick="edit(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;edit&quot;)" onmouseout="chnage_icons_src(this,&quot;edit&quot;)"></div><div id="duplicate_'.$id.'" valign="middle" class="element_toolbar"></div><div id="page_up_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/page_up.png" title="Move the field to the upper page" onclick="page_up(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;page_up&quot;)" onmouseout="chnage_icons_src(this,&quot;page_up&quot;)"></div><div id="page_down_'.$id.'" valign="middle" class="element_toolbar"><img src="' . MWD_URL . '/images/page_down.png" title="Move the field to the lower page" onclick="page_down(&quot;'.$id.'&quot;)" onmouseover="chnage_icons_src(this,&quot;page_down&quot;)" onmouseout="chnage_icons_src(this,&quot;page_down&quot;)"></div></div>';
							break;
						}
					...
					switch ($type) {
						...
						case 'type_name': {
							$params_names = array('w_field_label_size','w_field_label_pos','w_size','w_first_val', 'w_title','w_required');
							$temp = $params;
							foreach ($params_names as $params_name) {
								$temp = explode('*:*' . $params_name . '*:*', $temp);
								$param[$params_name] = $temp[0];
							...
							$rep ='<div id="wdform_field'.$id.'" type="type_name" class="wdform_field" style="display: table-cell;">'.$arrows.'<div align="left" id="'.$id.'_label_sectionform_id_temp" style="display: '.$param['w_field_label_pos'].'; width: '.$param['w_field_label_size'].'px;"><span id="'.$id.'_element_labelform_id_temp" class="label" style="vertical-align: top;">'.$label.'</span><span id="'.$id.'_required_elementform_id_temp" class="required" style="vertical-align: top;">'.$required_sym.'</span></div><div align="left" id="'.$id.'_element_sectionform_id_temp" style="display: '.$param['w_field_label_pos'].'"><input type="hidden" value="type_text" name="'.$id.'_typeform_id_temp" id="'.$id.'_typeform_id_temp" /><input type="hidden" value="'.$param['w_required'].'" name="'.$id.'_requiredform_id_temp" id="'.$id.'_requiredform_id_temp" /><input type="text" class="'.$input_active.'" id="'.$id.'_elementform_id_temp" name="'.$id.'_elementform_id_temp" value="'.$param['w_first_val'].'" title="'.$param['w_title'].'" onfocus="delete_value(&quot;'.$id.'_elementform_id_temp&quot;)" onblur="return_value(&quot;'.$id.'_elementform_id_temp&quot;)" onchange="change_value(&quot;'.$id.'_elementform_id_temp&quot;)" style="width: '.$param['w_size'].'px;" '.$param['attributes'].' disabled /></div></div>';
						...
						case 'type_action':  {
							...
							$rep='<div id="wdform_field'.$id.'" type="type_action" class="wdform_field" style="display: table-cell;">'.$arrows.'<div align="left" id="'.$id.'_label_sectionform_id_temp" class="'.$param['w_class'].'" style="display: '.$param['w_field_label_pos'].'; width: '.$param['w_field_label_size'].'px;"><span id="'.$id.'_element_labelform_id_temp" class="label" style="vertical-align: top;">'.$label.'</span><span id="'.$id.'_required_elementform_id_temp" class="required" style="vertical-align: top;">'.$required_sym.'</span></div><div align="left" id="'.$id.'_element_sectionform_id_temp" class="'.$param['w_class'].'" style="display: '.$param['w_field_label_pos'].';"><input type="hidden" value="type_action" name="'.$id.'_typeform_id_temp" id="'.$id.'_typeform_id_temp"><input type="hidden" value="'.$param['w_required'].'" name="'.$id.'_requiredform_id_temp" id="'.$id.'_requiredform_id_temp"><input type="hidden" value="'.$param['w_field_option_pos'].'" id="'.$id.'_option_left_right"><input type="hidden" value="'.$param['w_type'].'" id="'.$id.'_wtypeform_id_temp">';

							if($param['w_type'] != 'select'){
								$rep .='<div style="display: table;"><div id="'.$id.'_table_little" style="display: table-row-group;" '.($param['w_flow']=='hor' ? 'for_hor="'.$id.'_hor"' : '').'>';
								if($param['w_flow']=='ver') {
									if($param['w_choices']){
										foreach($param['w_choices'] as $key => $choice) {
											$rep.='<div id="'.$id.'_element_tr'.$key.'" style="display: table-row;">';
											$choise_value = $param['w_choices_value'][$key];
											$id_suf = $param['w_type'] == 'checkbox' ? $key : '';

											$rep.='<div valign="top" id="'.$id.'_td_little'.$key.'" idi="'.$key.'" style="display: table-cell;"><label id="'.$id.'_label_element'.$key.'" class="ch-rad-label" for="'.$id.'_elementform_id_temp'.$key.'" style="float: none !important;">'.$param['w_choices'][$key].'</label><input type="'.$param['w_type'].'" id="'.$id.'_elementform_id_temp'.$key.'" name="'.$id.'_elementform_id_temp'.$id_suf.'" value="'.$choise_value.'" onclick="set_default(\''.$id.'\',\''.$key.'\',\'form_id_temp\')" '.$param['w_choices_checked'][$key].' '.$param['attributes'].' '.($param['w_field_option_pos']=='right' ? 'style="float:left !important;"' : "").' disabled></div>';
									...
									$rep.='<div id="'.$id.'_element_tr0" style="display: table-row;">';
									if($param['w_choices']){
										foreach($param['w_choices'] as $key => $choice) {
											$choise_value =	$param['w_choices_value'][$key];
											$id_suf = $param['w_type'] == 'checkbox' ? $key : '';
								...
								$rep.='<select id="'.$id.'_elementform_id_temp" name="'.$id.'_elementform_id_temp" onchange="set_select(this)" style="width: '.$param['w_size'].'px;"  '.$param['attributes'].' disabled>';
								if($param['w_choices']){
									foreach($param['w_choices'] as $key => $choice) {
						...
						case 'type_list':  {
							...
							$rep='<div id="wdform_field'.$id.'" type="type_list" class="wdform_field" style="display: table-cell;">'.$arrows.'<div align="left" id="'.$id.'_label_sectionform_id_temp" class="'.$param['w_class'].'" style="display: '.$param['w_field_label_pos'].'; width: '.$param['w_field_label_size'].'px;"><span id="'.$id.'_element_labelform_id_temp" class="label" style="vertical-align: top;">'.$label.'</span><span id="'.$id.'_required_elementform_id_temp" class="required" style="vertical-align: top;">'.$required_sym.'</span></div><div align="left" id="'.$id.'_element_sectionform_id_temp" class="'.$param['w_class'].'" style="display: '.$param['w_field_label_pos'].';"><input type="hidden" value="type_list" name="'.$id.'_typeform_id_temp" id="'.$id.'_typeform_id_temp"><input type="hidden" value="'.$param['w_required'].'" name="'.$id.'_requiredform_id_temp" id="'.$id.'_requiredform_id_temp"><input type="hidden" value="'.$param['w_field_option_pos'].'" id="'.$id.'_option_left_right"><input type="hidden" value="'.$param['w_type'].'" id="'.$id.'_wtypeform_id_temp">';
								...
								if($param['w_flow']=='ver') {
									...
									if($param['w_choices']){
										foreach($param['w_choices'] as $key => $choice) {
											...
											$rep.='<div valign="top" id="'.$id.'_td_little'.$key.'" idi="'.$key.'" style="display: table-cell;"><label id="'.$id.'_label_element'.$key.'" class="ch-rad-label" for="'.$id.'_elementform_id_temp'.$key.'" style="float: none !important;">'.(isset($param['w_choices'][$key]) ? $param['w_choices'][$key] : "").'</label><input type="'.$param['w_type'].'" id="'.$id.'_elementform_id_temp'.$key.'" name="'.$id.'_elementform_id_temp'.$id_suf.'" value="'.$choise_value.'" onclick="set_default(\''.$id.'\',\''.$key.'\',\'form_id_temp\')" '.$param['w_choices_checked'][$key].' '.$param['attributes'].' '.($param['w_field_option_pos']=='right' ? 'style="float:left !important;"' : "").' disabled></div>';
										}
									}
									$rep.='</div>';
								}
									...
									if(count($param['w_choices']) > (int)$param['w_rowcol'])
										for($l=0; $l<$param['w_rowcol']; $l++) {
											if($param['w_allow_other']=="yes" && $param['w_allow_other_num']==(int)$param['w_rowcol']*$i+$l)
												...
												>'.$param['w_choices'][(int)$param['w_rowcol']*$i+$l].'</label></div>';
											}
										}
									else
						...
						case 'type_date': {
							...
							$display_image_date = $param['w_show_image'] == 'yes' ? 'inline-block' : 'none';


							$rep ='<div id="wdform_field'.$id.'" type="type_date" class="wdform_field" style="display: table-cell;">'.$arrows.'<div align="left" id="'.$id.'_label_sectionform_id_temp" class="'.$param['w_class'].'" style="display: '.$param['w_field_label_pos'].'; width: '.$param['w_field_label_size'].'px;"><span id="'.$id.'_element_labelform_id_temp" class="label" style="vertical-align: top;">'.$label.'</span><span id="'.$id.'_required_elementform_id_temp" class="required" style="vertical-align: top;">'.$required_sym.'</span></div><div align="left" id="'.$id.'_element_sectionform_id_temp" class="'.$param['w_class'].'" style="display: '.$param['w_field_label_pos'].';"><input type="hidden" value="type_date" name="'.$id.'_typeform_id_temp" id="'.$id.'_typeform_id_temp">
							<input type="hidden" value="'.$param['w_required'].'" name="'.$id.'_requiredform_id_temp" id="'.$id.'_requiredform_id_temp"><input type="hidden" value="'.$param['w_show_image'].'" name="'.$id.'_show_imageform_id_temp" id="'.$id.'_show_imageform_id_temp"><input type="hidden" value="'.$param['w_disable_past_days'].'" name="'.$id.'_dis_past_daysform_id_temp" id="'.$id.'_dis_past_daysform_id_temp"><input type="hidden" value="'.$param['w_default_date'].'" name="'.$id.'_default_date_id_temp" id="'.$id.'_default_date_id_temp"><input type="hidden" value="'.$param['w_min_date'].'" name="'.$id.'_min_date_id_temp" id="'.$id.'_min_date_id_temp"><input type="hidden" value="'.$param['w_max_date'].'" name="'.$id.'_max_date_id_temp" id="'.$id.'_max_date_id_temp"><input type="hidden" value="'.$param['w_invalid_dates'].'" name="'.$id.'_invalid_dates_id_temp" id="'.$id.'_invalid_dates_id_temp"><input type="hidden" value="'.$param['w_start_day'].'" name="'.$id.'_start_dayform_id_temp" id="'.$id.'_start_dayform_id_temp"><input type="hidden" value="'.$param['w_hide_time'].'" name="'.$id.'_hide_timeform_id_temp" id="'.$id.'_hide_timeform_id_temp"><input type="hidden"  name="'.$id.'_show_week_days" id="'.$id.'_show_week_days" sunday="'.$w_show_week_days[0].'" monday="'.$w_show_week_days[1].'" tuesday="'.$w_show_week_days[2].'" wednesday="'.$w_show_week_days[3].'" thursday="'.$w_show_week_days[4].'" friday="'.$w_show_week_days[5].'" saturday="'.$w_show_week_days[6].'"><input type="text"  id="'.$id.'_elementform_id_temp" name="'.$id.'_elementform_id_temp" style="width: '.$param['w_size'].'px;" '.$param['attributes'].' dtype="'.$param['w_dtype'].'" disabled/><img src="' . MWD_URL . '/images/date.png"  id="'.$id.'_show_imagedateform_id_temp" name="'.$id.'_show_imagedateform_id_temp" style="cursor: pointer;margin-left: -23px;display: inline; margin-top: 4px; display:'.$display_image_date.'"><input id="'.$id.'_buttonform_id_temp" type="hidden" format="'.$param['w_format'].'" ></div></div>';
						...
						case 'type_paypal_select': {
							...
							if($param['w_property'][0])
								foreach($param['w_property'] as $key => $property) {
									$rep.='<span id="'.$id.'_property_'.$key.'" style="margin-right: 15px;"><label class="mini_label" id="'.$id.'_property_label_form_id_temp'.$key.'" style="margin-right: 5px;">'.$property.'</label><select id="'.$id.'_propertyform_id_temp'.$key.'" name="'.$id.'_propertyform_id_temp'.$key.'" style="width: auto; margin: 2px 0px;" disabled>';
						...
						case 'type_star_rating': {
							...
							for($i=0; $i<$param['w_star_amount']; $i++) {
								$images .= '<img id="'.$id.'_star_'.$i.'" src="' . MWD_URL . '/images/star.png" onmouseover="change_src('.$i.','.$id.',&quot;form_id_temp&quot;)" onmouseout="reset_src('.$i.','.$id.')" onclick="select_star_rating('.$i.','.$id.', &quot;form_id_temp&quot;)">';
							}
						...
						case 'type_grading': {
							...
							for($i=0; $i<count($w_items); $i++) {
								$grading_items .= '<div id="'.$id.'_element_div'.$i.'" class="grading"><input type="text" id="'.$id.'_elementform_id_temp_'.$i.'" name="'.$id.'_elementform_id_temp_'.$i.'" onkeypress="return check_isnum_or_minus(event)" value="" size="5" onkeyup="sum_grading_values('.$id.',&quot;form_id_temp&quot;)" onchange="sum_grading_values('.$id.',&quot;form_id_temp&quot;)" '.$param['attributes'].' disabled/><label id="'.$id.'_label_elementform_id_temp'.$i.'" class="ch-rad-label">'.$w_items[$i].'</label></div>';
							}
			...
			$row->header_hide_image = 1;
			$row->merge_variables = '{"EMAIL" : 1}';
			$row->groups = '{}';
			$row->subscribe_action = 1;
		}
		return $row;
	}
	...
	public function get_theme_rows_data($old = '') {
		global $wpdb;
		$rows = $wpdb->get_results("SELECT * FROM " . $wpdb->prefix . "mwd_themes ORDER BY id");
		return $rows;
	}

	public function get_labels($id) {
		global $wpdb;
		$rows = $wpdb->get_col("SELECT DISTINCT `element_label` FROM " . $wpdb->prefix . "mwd_forms_submits WHERE form_id=" . $id);
		return $rows;
	}

	public function is_paypal($id) {
		global $wpdb;
		$rows = $wpdb->get_var("SELECT COUNT(*) FROM " . $wpdb->prefix . "mwd_forms_sessions WHERE form_id=" . $id);
		return $rows;
	}

	public function mwd_posts_query() {
	...
	public function mwd_categories_query() {
	...
	public function page_nav() {
		...
		if(isset($_POST['search_select_value_list']) && (esc_html($_POST['search_select_value_list']) != '0'))
			$where[] = '`list_id` = "' . esc_html($_POST['search_select_value_list']) . '"';

		$where = (count($where) ? ' WHERE ' . implode(' AND ', $where) : '');
		$query = "SELECT COUNT(*) FROM " . $wpdb->prefix . "mwd_forms " . $where;
