...
function renew_account_data(account, profile){
	...
	var account_info = '';
  account_info += '<img src="'+profile['avatar_url']+'" />\
			<div class="profile-general">\
				<span class="mwd-profile-name">'+account['first_name']+'<br /> '+account['last_name']+'</span> ('+profile['role']+') \
			...
			<div class="mwd-mailchimp-connect-tab">\
				...
				<div class="mwd-row">\
					...
					<div class="mwd-value">\
						<input type="text" readonly="" value="" onclick="jQuery(this).select(); return false;" >\
					</div>\
				</div>\
			</div>';
