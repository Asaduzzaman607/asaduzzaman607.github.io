    ...
    <div class="mwd_upgrade wd-clear" >
			...
			<div class="wd-right">
				<div class="wd-table">
						...
						<div class="wd-cell wd-cell-valign-middle">
								<a href="https://web-dorado.com/products/wordpress-mailchimp-wd.html" target="_blank">
								<?php _e("UPGRADE TO PAID VERSION", "mwd-text"); ?>
								 </a> 
						</div>
				</div>                        
        </div>
...
<?php
  ...
  public static function mailchimp_curl_connect( $url, $request_type = 'GET', $api_key, $data = array(), $decode = TRUE ) {
    $url = 'https://' . substr($api_key,strpos($api_key,'-')+1) . '.api.mailchimp.com/3.0'.$url;
    if( $request_type == 'GET' )
