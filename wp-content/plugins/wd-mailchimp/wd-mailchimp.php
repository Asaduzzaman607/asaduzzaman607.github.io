...
function mwd_options_panel() {
	...
	if( get_option( "mwd_subscribe_done" ) == 1){
		...
		add_menu_page('MailChimp WD', 'MailChimp WD', 'manage_options', $parent_slug, 'mailchimp_wd', MWD_URL . '/images/mailchimp_wd.png');
	}
	
	
	$manage_page = add_submenu_page($parent_slug, 'MailChimp WD', 'MailChimp WD', 'manage_options', 'manage_mwd', 'mailchimp_wd');
