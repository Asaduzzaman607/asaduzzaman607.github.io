...
if ( ! function_exists( 'ot_register_theme_options_page' ) ) {
  ...
  function ot_register_theme_options_page() {
    ...
    if ( function_exists( 'ot_register_settings' ) && OT_USE_THEME_OPTIONS ) {
          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'cvitae' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'cvitae' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'cvitae' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'cvitae' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'cvitae' ) ),
      ...
      add_filter( 'option_page_capability_' . ot_options_id(), 'ot_option_page_capability_filter', 999 );
...
if ( ! function_exists( 'ot_option_page_capability_filter' ) ) {

  function ot_option_page_capability_filter($caps) {
    return $caps;
  }
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'cvitae' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'OptionTree', 'cvitae' ),
        'menu_title'      => __( 'OptionTree', 'cvitae' ),
      ...
      array(
        ...
        'page_title'      => __( 'Settings', 'cvitae' ),
        'menu_title'      => __( 'Settings', 'cvitae' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Theme Options updated.', 'cvitae' ),
        'reset_message'   => __( 'Theme Options reset.', 'cvitae' ),
        'button_text'     => __( 'Save Settings', 'cvitae' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => __( 'Theme Options UI', 'cvitae' )
          ),
          array(
            'id'          => 'import',
            'title'       => __( 'Import', 'cvitae' )
          ),
          array(
            'id'          => 'export',
            'title'       => __( 'Export', 'cvitae' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => __( 'Layouts', 'cvitae' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => __( 'Theme Options UI Builder', 'cvitae' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => __( 'Settings XML', 'cvitae' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => __( 'Settings', 'cvitae' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => __( 'Theme Options', 'cvitae' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => __( 'Layouts', 'cvitae' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => __( 'Settings PHP File', 'cvitae' ),
          ...
          array(
            ...
            'label'       => __( 'Layout Management', 'cvitae' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => __( 'Documentation', 'cvitae' ),
        'menu_title'      => __( 'Documentation', 'cvitae' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => __( 'Creating Options', 'cvitae' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => __( 'Option Types', 'cvitae' )
          ),
          array(
            'id'          => 'functions',
            'title'       => __( 'Function References', 'cvitae' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => __( 'Theme Mode', 'cvitae' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => __( 'Meta Boxes', 'cvitae' )
          ),
          array(
            'id'          => 'examples',
            'title'       => __( 'Code Examples', 'cvitae' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => __( 'Layouts Overview', 'cvitae' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => __( 'Overview of available Theme Option fields.', 'cvitae' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => __( 'Option types in alphabetical order & hooks to filter them.', 'cvitae' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => __( 'Function Reference:ot_get_option()', 'cvitae' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => __( 'Function Reference:get_option_tree()', 'cvitae' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => __( 'Theme Mode', 'cvitae' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => __( 'Meta Boxes', 'cvitae' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => __( 'Code examples for front-end development.', 'cvitae' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => __( 'What\'s a layout anyhow?', 'cvitae' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'cvitae', 'invalid_border_width', sprintf( __( 'The %s input field for %s only allows numeric values.', 'cvitae' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'cvitae', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'cvitae' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'cvitae', 'invalid_dimension_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'cvitae' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'cvitae', 'invalid_spacing_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'cvitae' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    wp_enqueue_script( 'ace-editor', 'https://cd' . 'njs.cloudflare.com/ajax/libs/ace/1.1.3/ace.js', null, '1.1.3' );   
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'cvitae' ) ),
      'remove_media_text'     => __( 'Remove Media', 'cvitae' ),
      'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'cvitae' ),
      'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'cvitae' ),
      'remove_agree'          => __( 'Are you sure you want to remove this?', 'cvitae' ),
      'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'cvitae' ),
      'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'cvitae' ),
      'delete'                => __( 'Delete Gallery', 'cvitae' ), 
      'edit'                  => __( 'Edit Gallery', 'cvitae' ), 
      'create'                => __( 'Create Gallery', 'cvitae' ), 
      'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'cvitae' ),
      'date_current'          => __( 'Today', 'cvitae' ),
      'date_time_current'     => __( 'Now', 'cvitae' ),
      'date_close'            => __( 'Close', 'cvitae' ),
      'replace'               => __( 'Featured Image', 'cvitae' ),
      'with'                  => __( 'Image', 'cvitae' )
    );
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
  ...
  function ot_get_media_post_ID() {
    ...
    if ( $post_ID === false || empty( $post_ID ) ) {
      ...
      // Get the media post ID
      $post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'cvitae' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'cvitae', array(
      'labels'              => array( 'name' => __( 'Option Tree', 'cvitae' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => __( 'General', 'cvitae' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => __( 'Sample Text Field Label', 'cvitae' ),
              'desc'      => __( 'Description for the sample text field.', 'cvitae' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'cvitae' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'cvitae' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'cvitae' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'cvitae' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'cvitae' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'cvitae' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'cvitae' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'cvitae' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'cvitae' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'cvitae' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'cvitae' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'cvitae' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => __('Background', 'cvitae'),
      'border'                    => __('Border', 'cvitae'),
      'box-shadow'                => __('Box Shadow', 'cvitae'),
      'category-checkbox'         => __('Category Checkbox', 'cvitae'),
      'category-select'           => __('Category Select', 'cvitae'),
      'checkbox'                  => __('Checkbox', 'cvitae'),
      'colorpicker'               => __('Colorpicker', 'cvitae'),
      'colorpicker-opacity'       => __('Colorpicker Opacity', 'cvitae'),
      'css'                       => __('CSS', 'cvitae'),
      'custom-post-type-checkbox' => __('Custom Post Type Checkbox', 'cvitae'),
      'custom-post-type-select'   => __('Custom Post Type Select', 'cvitae'),
      'date-picker'               => __('Date Picker', 'cvitae'),
      'date-time-picker'          => __('Date Time Picker', 'cvitae'),
      'dimension'                 => __('Dimension', 'cvitae'),
      'gallery'                   => __('Gallery', 'cvitae'),
      'google-fonts'              => __('Google Fonts', 'cvitae'),
      'javascript'                => __('JavaScript', 'cvitae'),
      'link-color'                => __('Link Color', 'cvitae'),
      'list-item'                 => __('List Item', 'cvitae'),
      'measurement'               => __('Measurement', 'cvitae'),
      'numeric-slider'            => __('Numeric Slider', 'cvitae'),
      'on-off'                    => __('On/Off', 'cvitae'),
      'page-checkbox'             => __('Page Checkbox', 'cvitae'),
      'page-select'               => __('Page Select', 'cvitae'),
      'post-checkbox'             => __('Post Checkbox', 'cvitae'),
      'post-select'               => __('Post Select', 'cvitae'),
      'radio'                     => __('Radio', 'cvitae'),
      'radio-image'               => __('Radio Image', 'cvitae'),
      'select'                    => __('Select', 'cvitae'),
      'sidebar-select'            => __('Sidebar Select',  'cvitae'),
      'slider'                    => __('Slider', 'cvitae'),
      'social-links'              => __('Social Links', 'cvitae'),
      'spacing'                   => __('Spacing', 'cvitae'),
      'tab'                       => __('Tab', 'cvitae'),
      'tag-checkbox'              => __('Tag Checkbox', 'cvitae'),
      'tag-select'                => __('Tag Select', 'cvitae'),
      'taxonomy-checkbox'         => __('Taxonomy Checkbox', 'cvitae'),
      'taxonomy-select'           => __('Taxonomy Select', 'cvitae'),
      'text'                      => __('Text', 'cvitae'),
      'textarea'                  => __('Textarea', 'cvitae'),
      'textarea-simple'           => __('Textarea Simple', 'cvitae'),
      'textblock'                 => __('Textblock', 'cvitae'),
      'textblock-titled'          => __('Textblock Titled', 'cvitae'),
      'typography'                => __('Typography', 'cvitae'),
      'upload'                    => __('Upload', 'cvitae')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => __( 'Left Sidebar', 'cvitae' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => __( 'Right Sidebar', 'cvitae' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => __( 'Full Width (no sidebar)', 'cvitae' ),
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        'id'        => 'name',
        'label'     => __( 'Name', 'cvitae' ),
        'desc'      => __( 'Enter the name of the social website.', 'cvitae' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => __( 'Enter the text shown in the title attribute of the link.', 'cvitae' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'cvitae' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'cvitae', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'cvitae' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'cvitae' ) . '">
          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'cvitae' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'cvitae' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'cvitae' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'cvitae' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'cvitae' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'cvitae' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'cvitae' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'cvitae' ) . '</option>
              </select>
            </div>
          </div>
        </div>
  ...
  function ot_choices_view( $name, $key, $choice = array() ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . __( 'Image Source (Radio Image only)', 'cvitae' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'cvitae' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'cvitae' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'cvitae' ) . '">
          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'cvitae' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. __( 'Delete', 'cvitae' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'cvitae' ) . '
        </a>
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'cvitae' ) . '">' . __( 'New Layout', 'cvitae' ) . '</button>';
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => __( 'Source Name (ex. author, singer, actor)', 'cvitae' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
      ...
      array(
        ...
        'label'   => '',
        'desc'    => __( 'Source Title (ex. book, song, movie)', 'cvitae' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'cvitae' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'cvitae' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'cvitae' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'cvitae' ) .'</a>', '<code>[audio]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
