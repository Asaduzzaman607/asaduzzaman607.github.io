 ...
 * @since     2.1
 */
if ( ! function_exists( 'ot_register_theme_options_admin_mb' ) ) {

  function ot_register_theme_options_admin_mb( $wp_admin_bar ) {
    ...
    $wp_admin_bar->add_node( array(
      ...
      'title'   => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'cvitae' ) ),
