...
if ( ! class_exists( 'OT_Meta_Box' ) ) {
  ...
  class OT_Meta_Box {
    ...
    function __construct( $meta_box ) {
      ...
      add_action( 'add_' . 'meta_boxes', array( $this, 'add_boxes' ) );
     ...
     */
    function add_boxes() {
      $function = 'add_' . 'meta_box';
      foreach ( (array) $this->meta_box['pages'] as $page ) {
        $function( $this->meta_box['id'], $this->meta_box['title'], array( $this, 'build_meta_box' ), $page, $this->meta_box['context'], $this->meta_box['priority'], $this->meta_box['fields'] );
      }
    }
