    ...
    <div class="left_content"> 
      <div id="back">
        ...
        <div class="responsive_menu" >
          <div class="active_menu_responsive"> <p><span style="display:inline-block; float:left; padding:0 10px;">  <span id='trigram-for-heaven'></span></span><span style="position:relative;"><?php echo __('Menu', WDWT_LANG); ?> </span></p> </div>        
        </div>
