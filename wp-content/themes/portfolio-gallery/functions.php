...
define("WDWT_LANG", "portfolio-gallery");
...
function wdwt_widgets_init()
{
  ...
  register_sidebar(array(
      'name' => __('Sidebar Under Menu', WDWT_LANG),
      'id' => 'sidebar-3',
      'description' => __('Sidebar under menu', WDWT_LANG),
  ...
  register_sidebar(array(
      'name' => __('Footer Widget Area', WDWT_LANG),
      'id' => 'footer-widget-area',
      'description' => __('Footer widget area', WDWT_LANG),
...
//  add_theme_support( 'title-tag' );
  ...
  add_image_size( /*WDWT_SLUG.*/
    'gallery-width', 370, 310, true);
  ...
  // registr menu,
  register_nav_menu('primary-menu', __('Primary Menu', WDWT_LANG));
