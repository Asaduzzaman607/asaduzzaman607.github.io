...
<div class="right_container">
  ...
  <div id="content" class="blog">
    ...
    <form role="search" method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>">
      <div id="searchbox">
        <input type="text" id="searchinput" value="<?php echo get_search_query(); ?>" name="s" id="s"
               class="searchbox_search" placeholder="<?php echo __('Search...', WDWT_LANG); ?>"/>
    ...
    if (have_posts()) {
      ...
      <div id="blog-posts">
        ...
        while (have_posts()):
          the_post(); ?>
          <div class="blog-post <?php echo implode(' ', get_post_class());?>">
            <?php
  ...
  <script>
    ...
    <?php if($content_post_effect == "slide" ) { ?>
    jQuery(function ()
    {
  ...
  <div class="right_container">
    ...
    <div id="content" class="blog search-page">
      ...
      if (have_posts()) {
        ...
        <div id="image_list_top" class="image_list_top portfolio_list da-thumbs <?php echo $content_post_effect; ?>">
          <?php
          while (have_posts()):
            ...
            /*$id is the real id of post */
            ?>
            <div class="SearchPost <?php echo($article_class == "da-empty" ? "da-empty" : ""); echo ' ' . implode(' ',get_post_class()); ?>"
                 style="background-image:url(<?php echo $thumb_url ? esc_url($thumb_url) : ($content_posts_noimage ? esc_url($content_posts_noimage) : ""); ?>);">
              <?php //echo Portfolio_gallery_frontend_functions::fixed_thumbnail(250,230);
              ?>
              <article
                class="<?php echo $article_class; ?>" <?php echo ($content_post_effect == "slide") ? 'style="display: block;"' : ''; ?>>
                <h4 class="entry-title" rel="content-post-<?php echo $id; ?>-title"><?php the_title(); ?></h4>
                <span class="link_post"><a href="<?php echo get_permalink() ?>"><i class="fa fa-link"></i></a></span>
                <?php if ($thumb_url) { ?>
                  <span class="zoom">
                   <a href="<?php echo $full_img_url; ?>" class=" "
                      onclick="wdwt_lbox.init(this, 'wdwt-lightbox', <?php echo intval($lbox_width); ?> , <?php echo intval($lbox_height); ?>); return false;"
                      rel="wdwt-lightbox" id="content-post-<?php echo $id; ?>"><i class="fa fa-search-plus"></i>
                   </a>
                 </span>
                <?php } ?>
              </article>
