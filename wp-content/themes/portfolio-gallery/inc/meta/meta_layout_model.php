  ...
  function __construct(){
    ...
    $this->params = array(
      ...
      'menu_width' => array(
        ...
        'type' => 'text',
        "description" => __("Width of the Main Menu", WDWT_LANG),
        'input_size' => '2',
      ...
      'default_layout' => array(
        ...
        'type' => 'layout_open',
        "description" => __( "Content layout.", WDWT_LANG ),
        'valid_options' => array(
      ...
      'main_column' => array(
        ...
        'type' => 'text',
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Width of the Main Column", WDWT_LANG),
        'unit_symbol' => '%',
        'input_size' => '2',
      ...
      'pwa_width' => array(
        ...
        'type' => 'text',
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Width of the Primary Widget Area", WDWT_LANG),
        'unit_symbol' => '%',
        'input_size' => '2',
      ...
      'show_featured_image' => array(
        ...
        'title' =>  __( 'Show Featured Image', WDWT_LANG ),
        'type' => 'checkbox',
        'description' => __( 'Show Featured Image in single page/post view', WDWT_LANG ),
        'default' => $this->post_type_check() == 'page' ? false : true ,
      ),
      'show_single_page_title' => array(
        'name' => 'show_single_page_title',
        'title' =>  __( 'Show Page Title', WDWT_LANG ),
        'type' => 'checkbox',
        'description' => __( 'Show title in single page/post view', WDWT_LANG ),
        'default' => true ,
      ),
    );
