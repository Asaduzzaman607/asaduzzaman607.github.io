...
class Portfolio_gallery_events_categ extends WP_Widget
{
    function __construct(){
		$widget_ops = array('description' => __('Displays Events Categories Posts', WDWT_LANG));
		$control_ops = array('width' => '', 'height' => '');
		parent::__construct(false,$name=__('Events Categories Posts', WDWT_LANG),$widget_ops,$control_ops);
	}
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
				//Defaults
		$instance = wp_parse_args( (array) $instance, array( 'title'=>__('Events Categories Posts', WDWT_LANG), 'categ_id'=>'0', 'post_count'=>'3' ) );
...
add_action('widgets_init', 'portfolio_gallery_widget_events_category');
function portfolio_gallery_widget_events_category(){
  return register_widget("Portfolio_gallery_events_categ");
}
?>