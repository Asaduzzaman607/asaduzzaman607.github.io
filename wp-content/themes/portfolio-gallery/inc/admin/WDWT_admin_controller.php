...
function wdwt_get_tabs() {
  ...
  $tabs['general'] = array(
    ...
    'sections' => array(
      'general_main' => array(
        'name' => 'general_main',
        'title' => __( 'General - Main', WDWT_LANG ),
        'description' => ''
      ),
      'general_media' => array(
        'name' => 'general_media',
        'title' => __( 'General - Media', WDWT_LANG ),
        'description' => ''
      ),
      'general_links' => array(
        'name' => 'general_links',
        'title' => __( 'General - Links', WDWT_LANG ),
        'description' => ''
      ),
  ...
  $tabs['homepage']['sections']['homepage_featured'] = array(
      'name' => 'homepage_featured',
      'title' => __( 'Featured Post', WDWT_LANG ),
      'description' => ''
  );
  $tabs['homepage']['sections']['homepage_content'] = array(
      'name' => 'homepage_content',
      'title' => __( 'Content Posts', WDWT_LANG ),
      'description' => ''
  );
  ...
  $tabs['typography'] = array(
    ...
    'sections' => array(
      'text_headers' => array(
        'name' => 'text_headers',
        'title' => __( 'Typography - Headings', WDWT_LANG ),
        'description' => ''
      ),
      'primary_font' => array(
        'name' => 'primary_font',
        'title' => __( 'Typography - Primary Font' , WDWT_LANG),
        'description' => ''
      ),
      'secondary_font' => array(
        'name' => 'secondary_font',
        'title' => __( 'Typography - Secondary Font' , WDWT_LANG),
        'description' => ''
      ),
      'inputs_textareas' => array(
        'name' => 'inputs_textareas',
        'title' => __( 'Typography - Inputs and Text Areas', WDWT_LANG ),
        'description' => ''
      )
    ),
