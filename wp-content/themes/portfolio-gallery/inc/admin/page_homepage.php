  ...
  function __construct(){
    ...
    $this->options = array(
      ...
      "home_middle_description_post_enable" => array(
        ...
        "title" => __("Enable Featured Post", WDWT_LANG),
        'type' => 'checkbox',
        "description" => __( "Check box to display a featured post at the homepage", WDWT_LANG ),
      ...
      "home_middle_description_post" => array(
        ...
        "description" => __("Select the featured post. Pages selection is available in PRO version", WDWT_LANG ),
        'section' => 'homepage_featured', 
        'tab' => 'homepage', 
      ...
      'home_middle_image_maxwidth' => array( 
        ...
        "title" => "", 
        'type' => 'number', 
        "description" => __("Specify the maximum width of featured post image", WDWT_LANG),
        'input_size' => '4',
        "sanitize_type" => "sanitize_text_field", 
        'unit_symbol' => 'px',
        'min' => 100,
      ...
      'home_middle_description_pos' => array( 
        ...
        "title" => "", 
        'type' => 'number',
        "description" => __("Row where featured post should be shown. Enter integer from 1. This is applicable only for grid layout of content posts.", WDWT_LANG),
        'input_size' => '4',
        "sanitize_type" => "sanitize_text_field", 
        'section' => 'homepage_featured', 
        'tab' => 'homepage',
      ...
      "content_posts_enable" => array( 
        ...
        "title" => __("Enable Content Posts Filter", WDWT_LANG),
        'type' => 'checkbox',  
        "description" => __("Check the box to display posts only from specific categories. If unchecked, all posts are shown.", WDWT_LANG),
      ...
      "content_posts_layout" => array(
        ...
        'type' => 'radio_open',
        'valid_options' => array( 
          'thumb' => __('Grid', WDWT_LANG),
          'masonry' => __('Masonry', WDWT_LANG),
        ),
        'show' => array(
        ...
        'hide' => array(),
        "description" => __("Select view",WDWT_LANG),
        'section' => 'homepage_content',
        'tab' => 'homepage',
        'default' => 'thumb',
        'customizer'=>array()
      ...
      "content_post_categories" => array(
        ...
        "description" => __("Select categories of posts. Pages are available in PRO version.",WDWT_LANG),
        'section' => 'homepage_content',
        'tab' => 'homepage',
      ...
      'content_posts_masonry_title_pos' => array( 
        ...
        "title" => "", 
        'type' => 'select', 
        "description" => __("Title and description position", WDWT_LANG),
        'valid_options' => array( 
          'below' => __('Below thumb', WDWT_LANG),
          'above' => __('Above thumb', WDWT_LANG),
          'on_hover' => __('On hover', WDWT_LANG)
        ),
        'section' => 'homepage_content', 
        'tab' => 'homepage',
        'default' => 'on_hover',
      ...
      "content_posts_hover_btn" => array( 
        ...
        "title" => '',
        'type' => 'select',  
        "description" => __("Buttons and links on hover", WDWT_LANG),
        'valid_options' => array( 
          'lbox_and_link' => __('Lightbox and link buttons', WDWT_LANG),
          'link_only' => __('Title as a link, no lightbox button', WDWT_LANG),
          'lbox_only' => __('Only lightbox button, no link', WDWT_LANG),
        ),
        'section' => 'homepage_content', 
        'tab' => 'homepage', 
      ...
      "content_posts_masonry_hover_btn" => array( 
        ...
        "description" => __("Buttons and links on hover", WDWT_LANG),
        'valid_options' => array( 
          'lbox_and_link' => __('Title as a link and lightbox button', WDWT_LANG),
          'link_only' => __('Title as a link, no lightbox button', WDWT_LANG),
          'lbox_only' => __('Only lightbox button, no link', WDWT_LANG),
        ),
        'section' => 'homepage_content', 
      ...
      'content_posts_noimage' => array(
        ...
        'description' => __( 'Placeholder for Content Post if there is no thumb. Or leave blank and edit Post Thumb Background Color.', WDWT_LANG ), 
        'section' => 'homepage_content', 
        'tab' => 'homepage', 
        'default' => '',
        'customizer' => array()           
      ...
      'content_posts_maxnumber' => array( 
        ...
        "title" => "", 
        'type' => 'number', 
        "description" => __("Maximal number of posts to load in content posts", WDWT_LANG),
        'input_size' => '3',
        "sanitize_type" => "sanitize_text_field", 
        'section' => 'homepage_content', 
        'tab' => 'homepage',
    ...
    if ( is_plugin_active( 'slider-wd/slider-wd.php' )) {
      ...
      if(function_exists('wds_get_sliders')){
        $this->options['slider_wd_id'] = array( 
          "name" => "slider_wd_id", 
          "title" =>  __("Choose Slider",WDWT_LANG),
          'type' => 'select', 
          "sanitize_type" => "sanitize_text_field",
