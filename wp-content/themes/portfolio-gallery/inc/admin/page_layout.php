  ...
  function __construct(){
    ...
    $this->options = array( 
      ...
      'default_menu_layout' => array(
        ...
        "title" => __("Choose Default Menu Layout", WDWT_LANG), 
        'type' => 'layout', 
        "description" => __( "Default menu layout for pages and posts on the website.", WDWT_LANG ), 
        'valid_options' => array( 
      ...
      'menu_width' => array( 
        ...
        'type' => 'number', 
        "description" => __("Specify the width of the Main Menu", WDWT_LANG),
        'input_size' => '2',
      ...
      'default_layout' => array(
        ...
        'type' => 'layout_open', 
        "description" => __( "Default content layout for pages and posts on the website.", WDWT_LANG ), 
        'valid_options' => array( 
