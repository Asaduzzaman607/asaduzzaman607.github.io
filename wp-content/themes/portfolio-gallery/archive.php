...
<div class="right_container">
  ...
  <div id="content" class="blog archive-page">
    ...
    <?php if (have_posts()) : ?>
      ...
      <?php if (is_category()) { ?>
        <h1
          class="styledHeading"><?php _e('Archive For The ', WDWT_LANG); ?>&ldquo;<?php single_cat_title(); ?>&rdquo; <?php _e('Category', WDWT_LANG); ?></h1>
      <?php } elseif (is_tag()) { ?>
        <h1
          class="styledHeading"><?php _e('Posts Tagged ', WDWT_LANG); ?>&ldquo;<?php single_tag_title(); ?>&rdquo;</h1>
      <?php } elseif (is_day()) { ?>
        <h1
          class="styledHeading"><?php _e('Archive For ', WDWT_LANG); ?><?php the_time(get_option('date_format')); ?></h1>
      <?php } elseif (is_month()) { ?>
        <h1
          class="styledHeading"><?php _e('Archive For ', WDWT_LANG); ?><?php the_time(get_option('date_format')); ?></h1>
      <?php } elseif (is_year()) { ?>
      ...
      <?php } elseif (is_author()) { ?>
        <h1 class="styledHeading"><?php _e('Author Archive', WDWT_LANG); ?></h1>
      <?php } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
        <h1 class="styledHeading"><?php _e('Blog Archives', WDWT_LANG); ?></h1>
      <?php } ?>
    ...
    <?php else : ?>
      ...
      <h2 class="archive-header"><?php _e('Not Found', WDWT_LANG); ?></h2>
